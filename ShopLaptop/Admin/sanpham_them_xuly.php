<?php
	...
	else
	{
		...
		$sql = "insert into `tbl_sanpham`(`MaSanPham`, `TenSanPham`, `IdNhaSanXuat`, `HinhAnh`, `DonGia`, `MoTa`, `SoLuong`, `TiLeGiamGia`, `CauHinh`, `LuotXem`)
				VALUES ('$MaSanPham', '$TenSanPham', $IdNhaSanXuat,'$target_path', $DonGia, '$MoTa', $SoLuong, $TiLeGiamGia, '$CauHinh', 0)";
